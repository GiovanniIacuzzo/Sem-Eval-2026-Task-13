...
\begin{frame}{Subtask B: Inferenza Gerarchica (Cascade)}
    ...
    \vspace{0.3cm}
    % NOTA: I % alla fine delle righe delle colonne sono FONDAMENTALI in Beamer
...
\begin{frame}{Subtask B: Supervised Contrastive Learning}
    ...
    \begin{tikzpicture}[scale=0.6, transform shape,
        ...
        % Heads Branching (Semplificato per evitare errori di positioning)
    ...
    % Box senza centering esterno e senza itemize complesso
