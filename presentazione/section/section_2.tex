...
\begin{frame}{The Shift: Confronto Train vs Test}
    ...
    \begin{tcolorbox}[
        ...
        \small
        \textbf{\faExclamationTriangle \ Osservazione Critica:}
...
\begin{frame}{Code Properties: Human vs AI Verbosity}
    \vspace{-0.2cm}
    \small
    Esiste una differenza strutturale tra codice Umano e AI? Sì: la \textbf{Lunghezza}.
    \vspace{0.2cm}
...
\begin{frame}{Task B: Stylistic Fingerprints}
    \vspace{-0.2cm}
    \small
    Ogni famiglia di modelli ha una "firma" unica? Sì, la \textbf{lunghezza dei token} lo rivela.
    \vspace{0.2cm}
